...
const mockTasks = [
  ...
  {
    id: '4',
    title: 'Prepare monthly team presentation',
    description: 'Create slides and gather performance metrics',
    category: 'work',
    priority: 'medium',
    status: 'pending',
    dueDate: '2024-01-22',
...
export const TaskGrid: React.FC<TaskGridProps> = ({ searchQuery, filters }) => {
